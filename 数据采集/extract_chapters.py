# -*- coding: utf-8 -*-
"""截取 yuanzun_all.txt 章节内容保存到 yuanzun.txt"""

def extract_chapters():
    input_file = 'raw_books/yuanzun_all.txt'
    output_file = 'raw_books/yuanzun.txt'
    
    with open(input_file, 'r', encoding='utf-8') as f:
        lines = f.readlines()
    
    start_marker = '第九百一十四章'
    next_chapter_marker = '第九百八十八章'  # 第起始章开始，即终止章结束的下一行
